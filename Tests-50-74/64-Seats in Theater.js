// Test description:
// Your friend advised you to see a 
// new performance in the most popular theater in the city. 
// He knows a lot about art and his advice is usually good, 
// but not this time: the performance turned out to be 
// awfully dull. It's so bad you want to sneak out, which 
// is quite simple, especially since the exit is located 
// right behind your row to the left. All you need to do 
...
// couple of seconds) of all the people who sit behind you 
// and in your column or the columns to your left. To gain 
// some courage, you decide to calculate the number of such 
...
// Best solution:
function bestSolution(nCols, nRows, col, row) {
    return 1;
}
